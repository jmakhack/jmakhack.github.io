var how_to_menu_state = {

  /* Create the how to play menu */
  create: function() {
    ...
    var welcome = this.game.add.text(width/2, height/2, 'This is where the game instructions will be displayed.', style);
